...
<body>
	...
	<p>5) 폼 셀렉트 방스 요소값을 기본 데이터 타입인 문자열 타입 매개변수로 처리</p>
	<form action="/registerSelect" method="post">
		nationality : <br>
		<select name="nationality">
			<option value="korea">대한민국</option>
			<option value="germany">독일</option>
			<option value="oustrailia">호주</option>
	...
	<p>10) 폼 체크박스 요소값을 배열 타입 매개변수로 처리</p>
	...
	<p>11) 폼 체크박스 요소값을 문자열 요소를 가진 리스트 컬렉션 타입 매개변수 처리</p>
	...
	<p>13) 폼 체크박스 요소값을 기본 데이터 타입인 블리언 타입 매개변수로 처리</p>
	...
	<form action="/registerUserCardList" method="post">
		...
		카드1 - 유효원일 : <input type="text" name="cardList[0].validMonth"> <br>
		카드2 - 번호 : <input type="text" name="cardList[1].no"> <br>
		카드2 - 유효원일 : <input type="text" name="cardList[1].validMonth"> <br>
		<input type="submit" value="registerUserCardList"><br>
	</form> <br>
	
	<p>17) 폼 텍스트 영역 요소값을 기본 데이터 타입인 문자열 타입 매개변수로 처리</p>
	...
	<p>2) 파일업로드 폼 파일 요소값과 텍스트 필드 요소값을 MultipartFile 매개변수와 문자열매개변수로 처리</p>
	...
	<p>5) 여러개의 파일업로드를 폼 파일 요소값을 여러개의 multipartfile매개변수로 처리</p>
	...
	<p>6) 여러개의 파일업로드를 폼 파일 요소값을 multipartfile 타입의 요소를 가진 리스트 컬랙션 타입 매개변수로 처리</p>
	...
	<p>7) 여러개의 파일 업로드 폼 파일 요소값과 텍스트 필드 요소값을 MulfiFileMember 타입의 자바빈즈 매개변수로 처리</p>
	...
	<p>9) 파일업로드 폼 파일 요소값과 텍스트 필드 요소값을 MultipartFile 타입의 배열 매개변수로 처리한다.</p>
